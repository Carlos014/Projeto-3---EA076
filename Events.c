...
{
  /* Write your code here ... */
	meas = 1; // Interrupção periódica (400ms).
	timeh++;  
}

/*
** ===================================================================
**     Event       :  IRout_OnInterrupt (module Events)
**
**     Component   :  IRout [ExtInt]
**     Description :
...
{
  /* Write your code here ... */
	sum++; // Toma uma medida para cada vez que houver uma variação na leitura do receptor.
}
